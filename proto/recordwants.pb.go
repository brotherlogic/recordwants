...
var file_recordwants_proto_rawDesc = []byte{
	...
	0x01, 0x28, 0x03, 0x52, 0x09, 0x64, 0x61, 0x74, 0x65, 0x41, 0x64, 0x64, 0x65, 0x64, 0x22, 0xc8,
	0x04, 0x0a, 0x0a, 0x4d, 0x61, 0x73, 0x74, 0x65, 0x72, 0x57, 0x61, 0x6e, 0x74, 0x12, 0x2c, 0x0a,
	...
	0x74, 0x18, 0x0c, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x62, 0x75, 0x64, 0x67, 0x65, 0x74, 0x22,
	...
	0x4d, 0x45, 0x5f, 0x4c, 0x49, 0x53, 0x54, 0x10, 0x09, 0x22, 0x33, 0x0a, 0x05, 0x53, 0x70, 0x65,
	...
	0x73, 0x22, 0x82, 0x02, 0x0a, 0x0d, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x52, 0x65, 0x71, 0x75,
	...
	0x65, 0x4c, 0x65, 0x76, 0x65, 0x6c, 0x22, 0x10, 0x0a, 0x0e, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65,
	...
	,
...
var file_recordwants_proto_goTypes = []interface{}{
	...
	(*GetWantsRequest)(nil),   // 11: recordwants.GetWantsRequest
	(*GetWantsResponse)(nil),  // 12: recordwants.GetWantsResponse
	(*SyncRequest)(nil),       // 13: recordwants.SyncRequest
	(*SyncResponse)(nil),      // 14: recordwants.SyncResponse
	nil,                       // 15: recordwants.Config.SpendsEntry
	(*godiscogs.Release)(nil), // 16: godiscogs.Release
}
var file_recordwants_proto_depIdxs = []int32{
	3,  // 0: recordwants.Config.wants:type_name -> recordwants.MasterWant
	15, // 1: recordwants.Config.spends:type_name -> recordwants.Config.SpendsEntry
	16, // 2: recordwants.MasterWant.release:type_name -> godiscogs.Release
	...
	4,  // 5: recordwants.SpendingResponse.spends:type_name -> recordwants.Spend
	16, // 6: recordwants.UpdateRequest.want:type_name -> godiscogs.Release
	0,  // 7: recordwants.UpdateRequest.level:type_name -> recordwants.MasterWant.Level
	0,  // 8: recordwants.UpdateRequest.retire_level:type_name -> recordwants.MasterWant.Level
	0,  // 9: recordwants.AddWantRequest.level:type_name -> recordwants.MasterWant.Level
	0,  // 10: recordwants.AddWantRequest.retire_level:type_name -> recordwants.MasterWant.Level
	3,  // 11: recordwants.GetWantsResponse.want:type_name -> recordwants.MasterWant
	2,  // 12: recordwants.Config.SpendsEntry.value:type_name -> recordwants.RecordSpend
	5,  // 13: recordwants.WantService.GetSpending:input_type -> recordwants.SpendingRequest
	7,  // 14: recordwants.WantService.Update:input_type -> recordwants.UpdateRequest
	9,  // 15: recordwants.WantService.AddWant:input_type -> recordwants.AddWantRequest
	11, // 16: recordwants.WantService.GetWants:input_type -> recordwants.GetWantsRequest
	13, // 17: recordwants.WantService.Sync:input_type -> recordwants.SyncRequest
	6,  // 18: recordwants.WantService.GetSpending:output_type -> recordwants.SpendingResponse
	8,  // 19: recordwants.WantService.Update:output_type -> recordwants.UpdateResponse
	10, // 20: recordwants.WantService.AddWant:output_type -> recordwants.AddWantResponse
	12, // 21: recordwants.WantService.GetWants:output_type -> recordwants.GetWantsResponse
	14, // 22: recordwants.WantService.Sync:output_type -> recordwants.SyncResponse
